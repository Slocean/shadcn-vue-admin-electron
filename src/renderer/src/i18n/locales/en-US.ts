export default {
  ...
  home: {
    title: 'Home',
    welcome: 'Welcome back. Core desktop features are ready.',
    authStatus: 'Authentication status',
    signedInAs: 'Signed in as',
    sqlite: 'SQLite is wired through the main process',
    settings: 'Local preferences persist with electron-conf',
    i18n: 'Translations are powered by vue-i18n'
  },
  about: {
    title: 'About'
  },
